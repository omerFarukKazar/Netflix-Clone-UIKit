...
//  Netflix Clone App
//
//  Created by Ömer Faruk Kazar on 9.09.2022.
//

import UIKit

protocol CollectionViewTableViewCellDelegate: AnyObject {
    func collectionViewTableViewCellDidTappCell(_ cell: CollectionViewTableViewCell, viewModel: TitlePreviewViewModel)
}
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        APICaller.shared.getMovie(with: titleName + " trailer") { [weak self] result in
            ...
            case .success(let videoElement):
                ...
                self?.delegate?.collectionViewTableViewCellDidTappCell(strongSelf, viewModel: viewModel)
            case .failure(let error):
                print(error.localizedDescription)
            }
        }
